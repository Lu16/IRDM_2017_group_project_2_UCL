    ...
    with tf.Session() as sess:
        ...
        for m in range(1,5+1): # loop for training 5 folds
            ...
            for i in range(1,5000+1):
                ...
                train_data = file_train[list_train, 2:]
                ...
                if i % 100 == 0:
                    ...
                    test_data = file_vali[list_test, 2:]
                ...
                if i % 1000 == 0:
                    ...
                    if not os.path.exists('./GRU_model_noqid_' + str(m) + '/'):
                        os.mkdir('./GRU_model_noqid_' + str(m) + '/')
                    saver.save(sess, './GRU_model_noqid_' + str(m) + '/')
