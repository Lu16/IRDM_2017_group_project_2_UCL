...
file_ori_train = np.loadtxt('D:/UCL/IRDM/MSLR-WEB10K/Fold5/train_feature.txt')
...
file_ori_vali = np.loadtxt('D:/UCL/IRDM/MSLR-WEB10K/Fold5/test_feature.txt')
...
w_stack_hi = tf.Variable(tf.random_normal([17, hidden_unit]))
    ...
    with tf.device('/gpu:0'):
        with tf.Session() as sess:
            ...
            for indexIter in range(40000):
                ...
                batch_x = np.zeros([batch_size, 137])
            ...
            np.savetxt('D:/UCL/IRDM/CNN/CNN_5_001.txt', rank_results, delimiter=' ', newline='\r\n', fmt='%s')
